  ...
  public static final String findPatientsWhoArePregnantOrBreastfeeding(
    ...
    String query =
        "select patient_id from "
            ...
            + "	where prep_new.data_inicio_prep between '2024-05-05' and :endDate "
            ...
            + " "
            + "	where (lactante.data_lactante is not null or gravida.data_gravida is not null) and (consulta.data_inicio_prep=gravida.data_gravida or consulta.data_inicio_prep=lactante.data_lactante) "
            + "	) final "

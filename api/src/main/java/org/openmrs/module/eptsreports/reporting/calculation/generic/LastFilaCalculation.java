...
@Component
public class LastFilaCalculation extends FGHAbstractPatientCalculation {
  ...
  public CalculationResultMap evaluate( // FGHCalculationCohortDefinition cohortDefinition,
    ...
    Map<Integer, Object> lastFilaProcessorResults =
        Context.getRegisteredComponents(LastFilaProcessor.class).get(0).getResutls();

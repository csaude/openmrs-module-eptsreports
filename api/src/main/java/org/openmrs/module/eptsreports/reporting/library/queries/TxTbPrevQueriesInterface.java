    ...
    public static final String
      ...
      String query =
          "select inicio_TPT.patient_id 										"
              ...
              + "      			and e.encounter_datetime<=:endDate and e.location_id=:location and e.encounter_datetime > '0001-01-01 00:00:00' group by p.patient_id 					"
              + "      		union 																																					"
              ...
              + "      			and o.value_datetime is not null and  o.value_datetime<=:endDate and e.location_id=:location and o.value_datetime > '0001-01-01 00:00:00' group by p.patient_id "
              + "      		union 																																					"
              + "      		select pg.patient_id,min(date_enrolled) data_inicio from patient p 																						"
              + "      			inner join patient_program pg on p.patient_id=pg.patient_id 																						"
              + "      		where pg.voided=0 and p.voided=0 and program_id=2 and date_enrolled<=:endDate and location_id=:location and date_enrolled > '0001-01-01 00:00:00' group by pg.patient_id "
              + "      		union 																																					"
              ...
              + "      				p.voided=0 and e.encounter_type=18 AND e.voided=0 and e.encounter_datetime<=:endDate and e.location_id=:location and e.encounter_datetime > '0001-01-01 00:00:00' GROUP BY  p.patient_id "
              + "      		union 																																					"
              + "      		select p.patient_id,min(value_datetime) data_inicio from patient p 																						"
              + "      			inner join encounter e on p.patient_id=e.patient_id 																								"
              + "      			inner join obs o on e.encounter_id=o.encounter_id 																									"
              + "      		where p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type=52 																					"
              + "      			and o.concept_id=23866 and o.value_datetime is not null and  o.value_datetime<=:endDate and e.location_id=:location and o.value_datetime > '0001-01-01 00:00:00' group by p.patient_id "

...
public class FGHCalculationCohortDefinition extends BaseCohortDefinition {
  ...
  /** Default constructor */
  public FGHCalculationCohortDefinition() {}
   ...
   */
  public FGHCalculationCohortDefinition(FGHPatientCalculation calculation) {
   ...
   * @param calculation the calculation
   */
  public FGHCalculationCohortDefinition(String name, FGHPatientCalculation calculation) {
    setName(name);
    setCalculation(calculation);
  }

  /** @return the calculation */
  public FGHPatientCalculation getCalculation() {
    return calculation;
  }

  /** @param calculation the calculation to set */
  public void setCalculation(FGHPatientCalculation calculation) {

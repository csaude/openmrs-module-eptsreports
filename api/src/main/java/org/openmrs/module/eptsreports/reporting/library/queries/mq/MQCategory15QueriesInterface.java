  ...
  class QUERY {
    ...
    public static final String findPatientsFromFichaClinicaForGivenConceptsDenominadorCategoria15A =
        " select patient_id from "
            ...
            + "where  e.encounter_type = 6 and e.location_id=:location and e.voided =0 and o.concept_id=165174 and o.value_coded in((23724,23730)) and o.voided=0 "
    ...
    public static final String
        findPatientsFromFichaClinicaForGivenConceptsDenominadorCategoria15ARF6 =
            "select result.patient_id from  ( "
                ...
                + "join obs o on o.encounter_id=e.encounter_id "
                + "join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
                + "where  e.encounter_type = 6 and e.location_id=:location and e.voided =0 and o.concept_id=165174 and o.value_coded in(23730) and o.voided=0 "
                + "and grupo.concept_id=165323 and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded = 1256  and obsEstado.voided=0  and grupo.voided=0 "
                + "and grupo.obs_id=o.obs_group_id and grupo.obs_id=obsEstado.obs_group_id "
                + "group by mdcs.patient_id "
                + "union "
    ...
    public static final String findPatientsOnDMCWhoHaveTwoVLRequestAndOneVLResultWhoOnDT =
        "		select result.patient_id  from  ( "
            + "			select f.patient_id, data_mdc,final.encounter_datetime_pedido_1, e.encounter_datetime encounter_datetime_pedido_2   from ( "
            ...
            + "group by p.patient_id "
            + ")mdcs "
            + "join encounter e on (mdcs.patient_id=e.patient_id and mdcs.data_mdc = e.encounter_datetime) "
            + "join obs grupo on grupo.encounter_id=e.encounter_id "
            + "join obs o on o.encounter_id=e.encounter_id "
            + "join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "where  e.encounter_type = 6 and e.location_id=:location and e.voided =0 and o.concept_id=165174 and o.value_coded in (%d) and o.voided=0 "
            + "and grupo.concept_id=165323 and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded = 1256  and obsEstado.voided=0  and grupo.voided=0 "
            + "and grupo.obs_id=o.obs_group_id and grupo.obs_id=obsEstado.obs_group_id "
            + "group by mdcs.patient_id "
            + "            union "
    ...
    public static final String findPatientsOnDMCWhoOnDTAndHaveTwoRequestVLAndVLOnLabForm =
        "select result.patient_id from  ( "
            ...
            + "            )cvSegundoPedido on cvSegundoPedido.patient_id=final.patient_id "
            + "			where  cvSegundoPedido.encounter_datetime>final.encounter_datetime_pedido_1 "
            + "            and final.encounter_datetime_pedido_1>=f.data_mdc "
            + "            and cv.encounter_datetime > final.encounter_datetime_pedido_1 "
            + "            and cv.encounter_datetime<cvSegundoPedido.encounter_datetime "
            + "            group  by f.patient_id "
            + "            )result "
            + " inner join "
            + "     ( "
    ...
    public static final String findPatientsWhoHaveCD4OverThan1000 =
        "select cd4.patient_id from ( "
            + "select patient_id, max(data_cd4) data_cd4 from ( "
            + "Select p.patient_id, max(o.obs_datetime) as data_cd4 "
            + "From patient p "
            + "inner join encounter e on p.patient_id=e.patient_id "
            + "inner join obs o on e.encounter_id=o.encounter_id "
            ...
            + "inner join encounter e on p.patient_id=e.patient_id "
            + "inner join obs o on e.encounter_id=o.encounter_id "
            + "where p.voided=0 and e.voided=0 and o.voided=0 and concept_id = 165515 and  e.encounter_type = 6 and o.value_coded=165513 and e.location_id=:location and e.encounter_datetime <=:endRevisionDate "
            + "group by p.patient_id "
            + ") maxCd4 group by maxCd4.patient_id "
            + ")cd4 "
            + "left join( "
    ...
    public static final String findPatientsWithMDSWhoHaveTwoVLRequestAndOneVLResult =
        "         select result.patient_id from  ( "
            ...
            + "            inner join encounter e on e.patient_id=p.patient_id "
            + "            inner join obs o on o.encounter_id=e.encounter_id "
            + "            where o.concept_id=23722 and o.value_coded=856 and e.location_id = :location "
            + "            and p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type=6 and e.encounter_datetime<=:endRevisionDate "
            + "            )cvpedido "
            + "            )final on final.patient_id=f.patient_id "
            + "             inner join "

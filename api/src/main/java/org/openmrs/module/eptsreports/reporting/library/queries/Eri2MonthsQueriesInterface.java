    ...
    public static final String
      ...
      String query =
          "SELECT patient_id FROM "
              ...
              + "WHERE pg.voided=0 and ps.voided=0 and p.voided=0 AND pg.program_id=2 AND ps.state = 10 AND ps.end_date is null AND ps.start_date<=(:endDate + INTERVAL 3 DAY) and location_id=:location "
              + "group by pg.patient_id "
              + "union "
              ...
              + "INNER JOIN patient_program pg ON p.patient_id=pg.patient_id "
              + "inner join patient_state ps on pg.patient_program_id=ps.patient_program_id "
              + "WHERE pg.voided=0 and ps.voided=0 and p.voided=0 AND pg.program_id=2 AND ps.state = 8 AND ps.end_date is null "

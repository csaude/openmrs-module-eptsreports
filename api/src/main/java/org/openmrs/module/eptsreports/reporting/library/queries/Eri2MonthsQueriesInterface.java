...
public interface Eri2MonthsQueriesInterface {
  class QUERY {
    ...
    public static final String
      ...
      String query =
          "SELECT allPatient2Month.patient_id FROM "
              + "( "
              ...
              + "INNER JOIN encounter e on p.patient_id=e.patient_id "
              + "where p.voided=0 and e.voided=0 and  e.encounter_type = 18 AND e.encounter_datetime between (:endDate - INTERVAL 2 MONTH  + INTERVAL 1 DAY) and (:endDate + INTERVAL 3 DAY)  and e.location_id=:location "
              + "UNION "
              ...
              + "and o.value_datetime between  (:endDate - INTERVAL 2 MONTH  + INTERVAL 1 DAY) and (:endDate + INTERVAL 3 DAY) "
              ...
              + "AND ps.start_date<=(:endDate + INTERVAL 3 DAY) and location_id=:location "
              + "group by pg.patient_id "
              + "union "
              ...
              + "o.concept_id in (6272,6273) and o.value_coded = 1366 AND o.obs_datetime <=(:endDate + INTERVAL 3 DAY) and e.location_id=:location "
              + "GROUP BY p.patient_id "
              + "union "
              + "select person_id as patient_id,death_date as data_estado,10 as state_id from person "
              + "where dead=1 and death_date is not null and death_date<=(:endDate + INTERVAL 3 DAY) "
              + "UNION "
              ...
              + "WHERE e.voided=0 and p.voided=0 and obsObito.voided=0 AND e.encounter_type in (21,36,37) "
              + "AND e.encounter_datetime<=(:endDate + INTERVAL 3 DAY) and e.location_id=:location "
              ...
              + "where  p.voided=0 and e.voided=0 and e.encounter_datetime<=(:endDate + INTERVAL 3 DAY) "
              + "and e.location_id=:location  and e.encounter_type in (18,6,9) "
              + "group by p.patient_id "
              + ") consultaLev "
              + "group by patient_id "
              + ") consultaOuARV on obitos.patient_id=consultaOuARV.patient_id "
              + "where (consultaOuARV.encounter_datetime<=obitos.data_estado or consultaOuARV.encounter_datetime is null) "
              + "and obitos.data_estado <=(:endDate + INTERVAL 3 DAY) "
              ...
              + "INNER JOIN patient_program pg ON p.patient_id=pg.patient_id "
              + "inner join patient_state ps on pg.patient_program_id=ps.patient_program_id "
              + "WHERE pg.voided=0 and ps.voided=0 and p.voided=0 AND pg.program_id=2 AND ps.state = 8 "
              + "AND ps.start_date<=(:endDate + INTERVAL 3 DAY) and location_id=:location "
              + "group by pg.patient_id "
              + "union "
              ...
              + "INNER JOIN obs  o on e.encounter_id=o.encounter_id "
              + "WHERE e.voided=0 and o.voided=0 AND p.voided=0 AND e.encounter_type in (53,6) and "
              + "o.concept_id in (6272,6273) and o.value_coded = 1709 AND o.obs_datetime<=(:endDate + INTERVAL 3 DAY) and e.location_id=:location "
              + "GROUP BY p.patient_id "
              + ")suspensos "
              + "left join "
              + "( "
              ...
              + "( "
              + "select p.patient_id,max(e.encounter_datetime) encounter_datetime from  patient p "
              + "inner join encounter e on e.patient_id=p.patient_id where  p.voided=0 and e.voided=0 and e.encounter_datetime<=(:endDate + INTERVAL 3 DAY) "
              + "and e.location_id=:location  and e.encounter_type = 18 "
              + "group by p.patient_id "
              + ") ultimoFila "
              + "group by patient_id "
              + ") ultimoFila on suspensos.patient_id=ultimoFila.patient_id "
              + "where (ultimoFila.encounter_datetime<=suspensos.data_estado  or ultimoFila.encounter_datetime is null) "
              + "and suspensos.data_estado<=(:endDate + INTERVAL 3 DAY) "
              ...
              + "                       		and ps.start_date<=(:endDate + INTERVAL 3 DAY) and pg.location_id=:location  group by pg.patient_id "
              + "              		) max_estado "
              ...
              + "                      	and o.obs_datetime<=(:endDate + INTERVAL 3 DAY) and e.location_id=:location "
              + "              			group by p.patient_id "
              + "              	     union "
              ...
              + "                               inner join encounter e on p.patient_id=e.patient_id "
              + "                               inner join obs o on o.encounter_id=e.encounter_id "
              + "                           where e.voided=0 and p.voided=0 and pe.voided = 0 and e.encounter_datetime<=(:endDate + INTERVAL 3 DAY) "
              ...
              + "					and e.location_id=:location  and e.encounter_datetime <=(:endDate + INTERVAL 3 DAY) "
              + "					group by p.patient_id "
              + "    		union "
              ...
              + "               and o.concept_id=23866 and o.value_datetime is not null and e.location_id=:location  and o.value_datetime <=(:endDate + INTERVAL 3 DAY) "
              + "         	group by p.patient_id "
              ...
              + "		where ultimo_levantamento.data_ultimo_levantamento <=(:endDate + INTERVAL 3 DAY) "
              + ") allSaida "
              + "inner join "
              + "( "
              + "select patient_id,max(ultimoFila.encounter_datetime) encounter_datetime from "
              ...
              + "( "
              + "SELECT maxState.patient_id FROM "
              + "( "
              + "SELECT p.patient_id, pg.patient_program_id, max(ps.start_date) as maxStateDate  FROM patient p "
              + "inner join patient_program pg on p.patient_id=pg.patient_id "
              + "inner join patient_state ps on pg.patient_program_id=ps.patient_program_id "

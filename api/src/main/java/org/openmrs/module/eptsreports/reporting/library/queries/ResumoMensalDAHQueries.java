  ...
  public static String getPatientsTransferredFromAnotherHealthFacilityLastMonth() {
    String query =
        "        select "
            ...
            + "			o.concept_id = 6273 and 1706 and e.location_id=:location and o.obs_datetime<=:endDate "
            + "			group by p.patient_id "
            + "			union "
            + "			select p.patient_id, max(o.obs_datetime) data_estado from patient p "
            + "			inner join encounter e on p.patient_id=e.patient_id "
            ...
            + "			o.concept_id = 6272 and 1706 and e.location_id=:location and o.obs_datetime<=:endDate "
            + "			group by p.patient_id "

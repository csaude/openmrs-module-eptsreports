    ...
    public static final String
      ...
      String query =
          "select inicio_real.patient_id from (select patient_id,min(data_inicio) data_inicio from ("
              ...
              + "e.encounter_type in (%s) and  o.concept_id in (856,1305) and o.obs_datetime > '0001-01-01 00:00:00' and  date(o.obs_datetime) between date_add(date_add(:endDate, interval -12 MONTH), interval 1 day) and :endDate and e.location_id=:location group by p.patient_id) carga_viral on inicio_real.patient_id=carga_viral.patient_id "
    ...
    public static final String
      ...
      String query =
          "select inicio_real.patient_id from( "
              ...
              + "inner join encounter e on p.patient_id=e.patient_id "
              + "inner join obs o on e.encounter_id=o.encounter_id "
              + "where p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type=52 and  o.concept_id=23866 and o.value_datetime is not null and o.value_datetime > '0001-01-01 00:00:00' and  o.value_datetime<=:endDate and e.location_id=:location group by p.patient_id) inicio group by patient_id)inicio_real "
              + "inner join ( "
              + "Select p.patient_id,max(o.obs_datetime) data_carga from patient p "
              + "inner join encounter e on p.patient_id=e.patient_id "
              + "inner join obs o on e.encounter_id=o.encounter_id "
              + "where p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type in (%s) and  o.concept_id in (856,1305) and o.obs_datetime > '0001-01-01 00:00:00' and  date(o.obs_datetime) between date_add(date_add(:endDate, interval -12 MONTH), interval 1 day) and :endDate and e.location_id=:location group by p.patient_id) carga_viral on inicio_real.patient_id=carga_viral.patient_id "
    ...
    public static final String
      ...
      String query =
          "select  inicio_real.patient_id from ( "
              ...
              + "Select p.patient_id,min(value_datetime) data_inicio from patient p "
              + "inner join encounter e on p.patient_id=e.patient_id "
              + "inner join obs o on e.encounter_id=o.encounter_id where p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type in (18,6,9,53) and  o.concept_id=1190 and o.value_datetime is not null and o.value_datetime > '0001-01-01 00:00:00' and  o.value_datetime<=:endDate and e.location_id=:location group by p.patient_id "
              + "union "
              ...
              + "inner join obs obscv on obscv.person_id=carga_viral.patient_id and date(obscv.obs_datetime)=date(carga_viral.data_carga) "

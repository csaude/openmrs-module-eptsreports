...
@Component
public class Indicator14DataSetDefinition extends BaseDataSet {
  ...
  public DataSetDefinition constructDataset() {
    ...
    dataSetDefinition.setName("Indicator 14");
    ...
    CohortDefinition indicator14 = this.resumoMensalCETACohortQueries.getPatientsIndicator14();

    dataSetDefinition.addDimension(
        "indicator14Dimension",
        EptsReportUtils.map(
            this.resumoMensalCETADimensions.getResumoMensalCETADimension(indicator14), mappings));

    final CohortIndicator rmCETAIndicator14 =
        this.eptsGeneralIndicator.getIndicator(
            "RMCETA", EptsReportUtils.map(indicator14, mappings));

    addRow(
        dataSetDefinition,
        "I14",
        "Nr de pacientes com trauma",
        EptsReportUtils.map(rmCETAIndicator14, mappings),
        resumoMensalCETADataSetDefinition.getColumns("indicator14Dimension"));

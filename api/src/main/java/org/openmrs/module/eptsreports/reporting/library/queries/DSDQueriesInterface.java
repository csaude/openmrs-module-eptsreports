  ...
  class QUERY {
    ...
    public static final String findPatientsWhoAreFastTrack =
        "select ultima_consulta.patient_id "
            ...
            + "	from patient p "
            + "		inner join encounter e on p.patient_id=e.patient_id "
            + "	where e.encounter_type in(6,9) and e.voided=0 and p.voided=0  and e.location_id=:location and e.encounter_datetime<=:endDate "
            + "		group by p.patient_id "
            + ")ultima_consulta "
    ...
    public static String findPatientsWhoAreIncludedInDSDModel(DSDDispensationInterval dsdInterval) {
      ...
      String sql =
          "select patient_id "
              ...
              + "		select * "
              + "		from "
              + "		(    select fila.patient_id, fila.data_consulta, fila.tipo_dispensa, fonte, ordem_mdc from ( "
              ...
              + "					group by p.patient_id "
              + "                ) maxEnc on maxEnc.patient_id = fila.patient_id "
              + "                where (fila.data_consulta>=mdc.data_consulta or mdc.data_consulta is null) and (fila.data_consulta >= maxEnc.data_clinica or maxEnc.patient_id is null) "
              + "			union "
              + "					select mdc.* from ( "
              + "			select ultimo_mdc.patient_id, "
              + "              		  ultimo_mdc.data_consulta, "
              ...
              + "				inner join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
              + "				where e.encounter_type=6 and e.location_id=:location "
              + "					and o.concept_id=165174 and o.voided=0 and o.value_coded in (23730,23888,165314,165340) "
              + "					and grupo.concept_id=165323  and grupo.voided=0 "
              ...
              + "			where e.voided = 0 and data_proximo_levantamento.voided = 0 and date(e.encounter_datetime) = date(ultimo_fila.data_ultimo_levantamento) and  e.encounter_type=18 "
              + "				and data_proximo_levantamento.concept_id =5096 and e.location_id = :location  group by ultimo_fila.patient_id "
              + "				)fila on fila.patient_id = mdc.patient_id "
              + "				where (fila.data_consulta < mdc.data_consulta or fila.patient_id is null) "
              + "			union "
              + "			select tipoDispensa.* from ( "
              ...
              + "			where e.voided = 0 and data_proximo_levantamento.voided = 0 and date(e.encounter_datetime) = date(ultimo_fila.data_ultimo_levantamento) and  e.encounter_type=18 "
              + "				and data_proximo_levantamento.concept_id =5096 and e.location_id = :location  group by ultimo_fila.patient_id "
              + "				)fila on fila.patient_id = tipoDispensa.patient_id "
              + "				where (fila.data_consulta < tipoDispensa.data_clinica or fila.patient_id is null) "
              + "		) todas_fontes "
              + "			order by patient_id, data_consulta desc, tipo_dispensa, fonte, ordem_mdc "
              + "	) primeira_fonte "
              + ") dispensa "
    ...
    public static final String findPatientsWhoAreIncludedInDSDModel(DSDModeTypeLevel1 dsdMode) {
      ...
      String sql =
          ""
              ...
              + "                        select "
              + "                            e.patient_id, "
              + "                            dp.value_datetime as data_consulta, "
              + "                            case md.value_coded "
              + "                                when 165177 then 1 "
              + "                                when 165179 then 2 "
              + "                                when 165178 then 3 "
              ...
              + "                            select "
              + "                                p.patient_id, "
              + "                                max(e.encounter_datetime) as max_encounter_datetime "
              + "                            from patient p "
              + "                            inner join encounter e on e.patient_id = p.patient_id "
              + "                            where p.voided = 0 "
              + "                              and e.voided = 0 "
              ...
              + "                            group by p.patient_id "
              + "                        ) ult "
              + "                        inner join encounter e on e.patient_id = ult.patient_id "
              + "                                               and e.encounter_datetime = ult.max_encounter_datetime "
              + "                                               and e.encounter_type = 18 "
              + "                                               and e.voided = 0 "
              + "                                               and e.location_id = :location "
              + "                        inner join obs dp on dp.encounter_id = e.encounter_id "
              + "                                          and dp.concept_id = 5096 "
              + "                                          and dp.voided = 0 "
              + "                        inner join obs md on md.encounter_id = e.encounter_id "
              + "                                          and md.concept_id = 165174 "
              + "                                          and md.voided = 0 "
              + "                    ) f "
              + "                    left join ( "
              + "                        select "
              + "                            p.patient_id, "
              + "                            max(e.encounter_datetime) as data_consulta "
              + "                        from patient p "
              + "                        inner join encounter e on e.patient_id = p.patient_id "
              + "                        inner join obs o on o.encounter_id = e.encounter_id "
              + "                        inner join obs grupo on grupo.encounter_id = e.encounter_id "
              ...
              + "                          and grupo.voided = 0 "
              + "                          and estado.concept_id = 165322 "
              + "                          and estado.value_coded = 1267 "
              + "                          and estado.voided = 0 "
              + "                          and grupo.obs_id = o.obs_group_id "
              + "                          and grupo.obs_id = estado.obs_group_id "
              + "                        group by p.patient_id "
              + "                    ) mdc on mdc.patient_id = f.patient_id "
              + "                    where mdc.data_consulta is null or f.data_consulta > mdc.data_consulta          "
              + "                 "
              + "                    union  "
              + "                          "
              + "                    select "
              ...
              + "                        select "
              + "                            e.patient_id, "
              + "                            e.encounter_datetime as data_consulta, "
              + "                            case o.value_coded "
              + "                                when 165315 then 1 "
              + "                                when 165179 then 2 "
              + "                                when 165178 then 3 "
              ...
              + "                            select "
              + "                                patient_id, "
              + "                                max(encounter_datetime) as data_consulta "
              + "                            from encounter "
              + "                            where voided = 0 "
              ...
              + "                            group by patient_id "
              + "                        ) ult on p.patient_id = ult.patient_id "
              + "                        inner join encounter e on e.patient_id = ult.patient_id "
              + "                                               and e.encounter_datetime = ult.data_consulta "
              + "                                               and e.encounter_type = 6 "
              + "                                               and e.location_id = :location "
              + "                                               and e.voided = 0 "
              + "                        inner join obs o on o.encounter_id = e.encounter_id "
              ...
              + "                                             and estado.concept_id = 165322 "
              + "                                             and estado.voided = 0 "
              + "                                             and estado.value_coded in (1256, 1257) "
              + "                        where p.voided = 0 "
              + "                          and grupo.obs_id = o.obs_group_id "
              + "                          and grupo.obs_id = estado.obs_group_id "
              + "                    ) td "
              ...
              + "                        select "
              + "                            e.patient_id, "
              + "                            max(dp.value_datetime) as data_proximo_levantamento "
              + "                        from patient p "
              + "                        inner join ( "
              + "                            select "
              + "                                patient_id, "
              ...
              + "                            from encounter "
              + "                            where voided = 0 "
              + "                              and encounter_type = 18 "
              + "                              and location_id = :location "
              + "                              and encounter_datetime <= :endDate "
              + "                            group by patient_id "
              + "                        ) ult on p.patient_id = ult.patient_id "
              + "                        inner join encounter e on e.patient_id = ult.patient_id "
              + "                                               and e.encounter_datetime = ult.max_date "
              + "                                               and e.encounter_type = 18 "
              + "                                               and e.location_id = :location "
              + "                                               and e.voided = 0 "
              + "                        inner join obs dp on dp.encounter_id = e.encounter_id "
              ...
              + "                                  and encounter_datetime <= :endDate "
              + "                                group by patient_id "
              + "                            ) ult2 on p.patient_id = ult2.patient_id "
              + "                            inner join encounter e on e.patient_id = ult2.patient_id "
              + "                                                   and e.encounter_datetime = ult2.max_date "
              + "                                                   and e.voided = 0 "
              + "                                                   and e.encounter_type = 18 "
              + "                                                   and e.location_id = :location "
              + "                            inner join obs dp on dp.encounter_id = e.encounter_id "
              ...
              + "                                             and md.concept_id = 165174 "
              + "                                             and md.voided = 0 "
              + "                        ) filawithmds on filawithmds.patient_id = e.patient_id "
              + "                        where filawithmds.patient_id is null "
              + "                        group by e.patient_id "
              + "                    ) filawithoutmds on filawithoutmds.patient_id = td.patient_id "
              + "                    where filawithoutmds.data_proximo_levantamento is null "
              + "                       or td.data_consulta > filawithoutmds.data_proximo_levantamento "
              + " "
              + "                       "
              + "                       ) todas_fontes  "
    ...
    public static final String findPatientsWhoAreIncludedInDSDModel(
      ...
      String sql =
          "select ultima_ficha.patient_id "
              ...
              + "	from patient p "
              + "		inner join encounter e on p.patient_id=e.patient_id "
              + "	where e.encounter_type=6 and e.voided=0 and p.voided=0  and e.location_id=:location and e.encounter_datetime<=:endDate "
              + "		group by p.patient_id "
              + ")ultima_ficha "

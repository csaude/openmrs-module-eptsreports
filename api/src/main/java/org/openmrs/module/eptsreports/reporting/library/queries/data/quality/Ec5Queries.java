  ...
  public static String getEc5CombinedQuery() {
    String query =
        "SELECT pe.person_id As patient_id, "
            ...
            + "date(colheitaFSRDate.dataColheitaFSR), "
            + "date(peObito.death_date), "
            + "deadFichaResumo.death_date "
            + "FROM person pe "
            ...
            + "requestLabDate.dataPedidoLab>deadFichaClinica.death_date or "
            + "requestLabDate.dataPedidoLab>deadHomeVisitCard.death_date "
            + ") "
            + "OR "
            + "( "
            ...
            + "colheitaLabDate.dataColheitaLab>deadFichaClinica.death_date or "
            + "colheitaLabDate.dataColheitaLab>deadHomeVisitCard.death_date "
            + ") "
            + "OR "
            + "( "
            + "date(colheitaFSRDate.dataColheitaFSR)>date(peObito.death_date) or "
            + "date(colheitaFSRDate.dataColheitaFSR)>date(deadPrograma.death_date) or "
            + "date(colheitaFSRDate.dataColheitaFSR)>date(deadFichaResumo.death_date) or "
            + "date(colheitaFSRDate.dataColheitaFSR)>date(deadFichaClinica.death_date) or "
            + "date(colheitaFSRDate.dataColheitaFSR)>date(deadHomeVisitCard.death_date) "
            + ") "
            + ") "

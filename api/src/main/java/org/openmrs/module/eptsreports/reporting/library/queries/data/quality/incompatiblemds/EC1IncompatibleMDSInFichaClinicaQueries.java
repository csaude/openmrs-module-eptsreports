...
public interface EC1IncompatibleMDSInFichaClinicaQueries {
  class QUERY {

    public static String findPatiendsWithIncompatibleMDSInFichaClinica =
        "    						select distinct patient.patient_id, "
            ...
            + "					where  e.encounter_type in(6) and e.location_id=:location and o.concept_id=165174 and o.value_coded = 23730 and o.voided=0 "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type in(6) and e.location_id=:location and o.concept_id=165174 and o.value_coded in (165314, 23888, 23724, 165317, 165320, 165321) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded = 23888 and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            + "					 ) ds "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (23724, 165178, 165179, 165317, 165318, 165320, 165321, 165315, 165314) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded = 23724 and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            + "					 ) ga "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (165178, 165179, 165265, 165317, 165320, 165321, 165315, 165314) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded = 165178 and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257) and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            + "					 ) dcp "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (165179, 165264, 165265, 165320, 165315, 165314, 165318) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded = 165179 and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            + "					 ) dca "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (165264, 165265, 165317, 165320, 165321, 165315, 165314, 165318) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded = 165264 and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            + "					 ) bm "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (23724, 165265, 165176, 165318, 165319, 165315, 165314) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded = 165265 and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            + "					 ) cm "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (165178, 165318, 165319, 165321, 165315, 165314) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded = 165317 and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            + "					 ) tb "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (165318, 165319, 165320, 165315, 165314) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded = 165318 and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            + "					 ) ct "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (165319) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded = 165320 and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            + "					 ) smi "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (165318, 165319, 165315, 165314) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded = 165315 and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            + "					 ) dd "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (165321) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded = 165314 and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "
            + "					 ) da "
            ...
            + "					join obs o on o.encounter_id=e.encounter_id "
            + "					join obs obsEstado on obsEstado.encounter_id=e.encounter_id "
            + "					where  e.encounter_type = 6 and e.location_id=:location and o.concept_id=165174 and o.value_coded in (165318, 165321, 165315) and o.voided=0 "
            + "					and grupo.concept_id=165323  and grupo.voided=0 and obsEstado.concept_id=165322  and obsEstado.value_coded in (1256, 1257)  and obsEstado.voided=0  and grupo.voided=0 "
            + "					and o.obs_group_id = obsEstado.obs_group_id "
            + "					and DATE(e.encounter_datetime) <= now() "

    			...
    			from ( 
		         	...
		         	select masterCard.patient_id, masterCard.data_estado                                                                              
	              	from (                                                                                                                              
	                      ...
	                      where e.voided=0 and p.voided=0 and o.obs_datetime <= CURDATE() and o.concept_id in (6272,6273)                                       
	                          and e.encounter_type in (53,6) and  e.location_id= :location                                                                 
	                          group by p.patient_id                                                                                                   
	                  ) masterCard                                                                                                                   
	                      inner join encounter e on e.patient_id = masterCard.patient_id                                                             
	                      inner join obs o on o.encounter_id = e.encounter_id                                                                         
	                 where e.encounter_type in (53,6) and o.voided=0 and o.concept_id in (6272,6273) and o.value_coded=1706 and masterCard.data_estado = o.obs_datetime and e.location_id = :location 

...
from(
		...
		from (
			...
			) final3hp on final3hp.patient_id = inicio_3HP.patient_id and final3hp.data_final_3hp >= inicio_3HP.data_inicio_3HP + interval 86 day and final3hp.data_final_3HP between :startDate and :endDate
		...
		from (
			...
			(
			 ...
			 where e.voided=0 and profilaxia3HP.voided=0 and profilaxia3HP.concept_id=23985 and profilaxia3HP.value_coded = 23954 and e.encounter_type=6 and  e.location_id=:location	
	            ...
	            where fim.encounter_datetime between inicio_3HP.data_inicio_3HP and (inicio_3HP.data_inicio_3HP + interval 4 month) and fim.encounter_datetime between :startDate and :endDate
	            group by inicio_3HP.patient_id
	...
	from (
		...
		(
			...
			where 	e.voided=0 and p.voided=0 and estadoProfilaxia.obs_datetime between (:startDate - interval 6 month) and :endDate 			  									
					and profilaxiaINH.voided=0 and profilaxiaINH.concept_id=23985 and profilaxiaINH.value_coded in (656,23982) and e.encounter_type in (6,9) 
					and e.encounter_datetime between :startDate and :endDate
					and  e.location_id=:location	  		
		...
		where e.voided=0 and e.encounter_datetime BETWEEN inicio_INH.data_inicio_INH 
		                 and  if(dispensa.value_coded=1098,(inicio_INH.data_inicio_INH +interval 7 month),(inicio_INH.data_inicio_INH +interval 5 month)) 
		                 and  e.encounter_datetime between :startDate and :endDate
		                 and  e.encounter_type=60 and e.location_id=:location and regime.voided=0 
		                 and  regime.concept_id=23985 and regime.value_coded in (656,23982) 
					  and  dispensa.voided=0 and dispensa.concept_id=23986 
					  and dispensa.value_coded in (1098,23720)
		group by inicio_INH.patient_id
		) fimINHFilt

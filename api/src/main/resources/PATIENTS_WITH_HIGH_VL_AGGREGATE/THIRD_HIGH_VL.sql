	...
	left join encounter consultaApss2CV3 on consultaApss2CV3.patient_id=HVL_FR30.patient_id and 
			...
			left join
				(
					...
					where colheitaRegistadaCV2.dataColheitaRegistadaCV2  is not null  and HVL_FR32.mudancaLinha<>'N'
				...
				)HVL_FR34 where HVL_FR34.resultadoTerceiraCV <>'Indetectavel'

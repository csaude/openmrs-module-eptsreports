		...
		select HVL_FR26.*,
			 ...
			 consultaApss2CV0.encounter_datetime
		...
		left join encounter consultaApss2CV0 on consultaApss2CV0.patient_id=HVL_FR26.patient_id and 
			...
			where consultaApss2CV0.encounter_datetime is not null and HVL_FR26.resultadoSegundaCV>1000 and HVL_FR26.dataApssAvaliarAdesao is not null

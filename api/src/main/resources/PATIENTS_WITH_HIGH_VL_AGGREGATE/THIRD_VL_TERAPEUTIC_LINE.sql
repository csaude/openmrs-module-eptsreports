		...
		from
		(
		select HVL_FR35.* ,consultaClinicaParaMudancaLinhaCV2.dataConsultaClinicaParaMudancaLinhaCV2
		from
		(
		select HVL_FR34.*, resultadoTerceiraCVValor.concept_id from
		(
		select HVL_FR33.*,resultadoTerceiraCVData.dataResultadoTerceiraCV from 
		(
		select HVL_FR32.*, colheitaRegistadaCV2.dataColheitaRegistadaCV2 from
		(
		select HVL_FR31.*,consultaClinicaPedidoCV2.dataConsultaClinicaPedidoCV2 from
		(
		select HVL_FR30.*, consultaApss2CV3.encounter_datetime dataConsultaApss2CV3 from
		(
		select HVL_FR29.*,consultaApss2CV2.encounter_datetime dataConsultaApss2CV2  from
		(
		select HVL_FR28.*,consultaApss2CV1.encounter_datetime dataConsultaApss2CV1 from
		(
		select HVL_FR26.*, inicioNovaLinha.value_coded, consultaApss2CV0.encounter_datetime dataConsultaApss2CV0 from
		(
		select HVL_FR25.*,consultaClinicaParaMudancaLinha.dataConsultaClinicaParaMudancaLinha from 
		(
		select HVL_FR24.* from
		(	
		select HVL_FR23.* from
		(
		select HVL_FR22.*,resultadoSegundaCVData.dataResultadoSegundaCV from
		(
		...
		(
			...
			--where consultaClinicaParaMudancaLinha.dataConsultaClinicaParaMudancaLinha is not null
		...
		left join encounter consultaApss2CV0 on consultaApss2CV0.patient_id=HVL_FR26.patient_id and 
		 ...
		 --where consultaApss2CV0.encounter_datetime is not null
         ...
         --  where consultaApss2CV1.encounter_datetime is not null
		...
		--where consultaApss2CV2.encounter_datetime is not null
		...
		--where consultaApss2CV3.encounter_datetime is not null
		...
		(
			...
			--where consultaClinicaPedidoCV2.dataConsultaClinicaPedidoCV2 is not null
		...
		(
			...
			--where resultadoTerceiraCVData.dataResultadoTerceiraCV is not null
			group by HVL_FR33.patient_id
				...
				--where resultadoTerceiraCVValor.patient_id is not null
				)HVL_FR35
				left join
				(
					...
					--where consultaClinicaParaMudancaLinhaCV2.dataConsultaClinicaParaMudancaLinhaCV2 is not null

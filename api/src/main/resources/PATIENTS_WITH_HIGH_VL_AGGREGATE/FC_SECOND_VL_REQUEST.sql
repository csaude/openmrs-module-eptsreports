		select HVL_FR20.patient_id from
		(
		select HVL_FR17.*,consultaApss3.encounter_datetime dataConsultaApss3 from
		(
		...
		o.concept_id=856 and o.obs_datetime BETWEEN '2024-03-20' and :endDate and e.location_id=3 and o.value_numeric>1000
		group by p.patient_id
		) primeiraCV
		...
		(
			...
			where consultaClinicaPedido.dataConsultaClinicaPedido is not null

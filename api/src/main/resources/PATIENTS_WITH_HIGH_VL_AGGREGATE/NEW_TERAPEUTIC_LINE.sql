								select HVL_FR25.patient_id from
								(
								select 
									HVL_FR25.*,min(consultaClinicaParaMudancaLinha.dataConsultaClinicaParaMudancaLinha) dataConsultaClinicaParaMudancaLinha
									...
									where  resultadoSegundaCVValor.dataResultadoSegundaCV is not null
							)HVL_FR24
					...
					(
						...
						where consultaClinicaParaMudancaLinha.dataConsultaClinicaParaMudancaLinha is not null and HVL_FR25.resultadoSegundaCV>=1000 

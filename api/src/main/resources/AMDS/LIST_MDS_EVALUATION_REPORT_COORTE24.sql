...
select * from (
      ...
      select primeiroMdc.patient_id,primeiroMdc.data_mdc data_registo_primeiro_mdc from 
       ...
       and inicioMds24Meses.data_inicio_mds_24_meses BETWEEN date_add(coorte24Meses.art_start_date, interval 12 month) and date_add(coorte24Meses.art_start_date, interval 24 month) 
        ...
        ) variaveisDatasCoorte24 on variaveisDatasCoorte24.patient_id = coorte24Meses.patient_id
  ...
  SELECT patient_id, if(ISNULL(data_inicio_tpt_24_meses),'Não', 'Sim') as tpt_24_meses,
      ...
      --todasConsultasFichaApss24Meses
       ...
       Select B7.patient_id, 1 tipo_saida from 
               ...
               ) variaveisDeTextoCoorte24 on variaveisDeTextoCoorte24.patient_id = coorte24Meses.patient_id
      ...
      select primeiroMdc.patient_id,primeiroMdc.data_mdc data_registo_primeiro_mdc from 
          ...
          select p.patient_id,e.encounter_datetime as data_mdc  from patient p 
              ...
              group by primeiroMdc.patient_id
                 ...
                 group by tmp.patient_id
       )variaveisDatasCoorte12 on variaveisDatasCoorte12.patient_id=coorte24Meses.patient_id  
       left join(
          select tmp.patient_id,
       ...
       ) variaveisDeTextoCoorte12 on variaveisDeTextoCoorte12.patient_id=coorte24Meses.patient_id

    ...
    (
      ...
      from 
        ...
        select coorte12Meses.patient_id,coorte12Meses.art_start_date, trasferedIn.data_transferencia,  '12' tipo_coorte   
         ...
         SELECT tx_new.patient_id,tx_new.art_start_date
           FROM 
              ...
              AND e.location_id=3 
              AND e.encounter_datetime <=date_sub(date(concat('2023','-06','-20')), interval 12 MONTH)
              ...
              AND o.value_datetime <=date_sub(date(concat('2023','-06','-20')), interval 12 MONTH)
              AND e.location_id=3 
              GROUP BY p.patient_id 
              ) 
              art_start GROUP BY patient_id 
          ) tx_new WHERE art_start_date BETWEEN  date_sub(date(concat('2023','-12','-21')), interval 24 MONTH) and  date_sub(date(concat('2023','-06','-20')), interval 12 MONTH)
            )coorte12Meses
            left join
        (
          SELECT tr.patient_id, tr.data_transferencia from  
              (
                ...
                WHERE p.voided=0 AND e.voided=0 AND e.encounter_type=53 and obsData.value_datetime<=date_sub(date(concat('2023','-06','-20')), interval 12 MONTH)
                AND e.location_id=3 
                GROUP BY p.patient_id 
                union
                ...
                WHERE pg.voided=0 
                and ps.start_date<=date_sub(date(concat('2023','-06','-20')), interval 12 MONTH)
                and ps.voided=0   
                and p.voided=0 
                and pg.program_id=2 
                and location_id=3  
         ...
         SELECT tx_new.patient_id,tx_new.art_start_date
           FROM 
              ...
              art_start GROUP BY patient_id 
          ) tx_new WHERE art_start_date BETWEEN  date_sub(date(concat('2023','-12','-21')), interval 36 MONTH) and  date_sub(date(concat('2023','-06','-20')), interval 24 MONTH)
            )coorte24Meses
            left join
        (
           SELECT tr.patient_id, tr.data_transferencia from  
              (
                ...
                INNER JOIN obs obsTrans ON e.encounter_id=obsTrans.encounter_id AND obsTrans.voided=0 AND obsTrans.concept_id=1369 AND obsTrans.value_coded=1065 
                INNER JOIN obs obsData ON e.encounter_id=obsData.encounter_id AND obsData.voided=0 AND obsData.concept_id=23891 
                WHERE p.voided=0 AND e.voided=0 AND e.encounter_type=53 and obsData.value_datetime<=date_sub(date(concat('2023','-06','-20')), interval 24 MONTH)
                AND e.location_id=3 
                GROUP BY p.patient_id 
                union
                select final.patient_id,final.minStateDate  as data_transferencia from  
                ...
                inner join patient_state ps on pg.patient_program_id=ps.patient_program_id  
                WHERE pg.voided=0 
                and ps.start_date<=date_sub(date(concat('2023','-06','-20')), interval 24 MONTH)
                and ps.voided=0 
                and p.voided=0 
                and pg.program_id=2 
                and location_id=3  
       ...
       (
            select tpt.patient_id,tpt.data_tb from 
              ...
              inner join encounter e on p.patient_id=e.patient_id 
              inner join obs o on o.encounter_id=e.encounter_id 
              where e.encounter_type=6 and  e.location_id=3 and e.voided=0 and p.voided=0 and o.voided=0 and  o.concept_id=23761  and o.value_coded=1065 
              union
              select p.patient_id,e.encounter_datetime data_tb,e.encounter_id from patient p 
              inner join encounter e on p.patient_id=e.patient_id 
              inner join obs o on o.encounter_id=e.encounter_id 
              where e.encounter_type=6 and  e.location_id=3 and e.voided=0 and p.voided=0 and o.voided=0 and   o.concept_id=23758  and o.value_coded=1065 
              union
              select p.patient_id,e.encounter_datetime data_tb,e.encounter_id from patient p 
              inner join encounter e on p.patient_id=e.patient_id 
              inner join obs o on o.encounter_id=e.encounter_id 
              where e.encounter_type=6 and  e.location_id=3 and e.voided=0 and p.voided=0 and  o.concept_id=1766  and o.value_coded in(1763,1764,1762,1760,23760,1765) 
              union
              select p.patient_id,e.encounter_datetime data_tb,e.encounter_id from patient p 
              inner join encounter e on p.patient_id=e.patient_id 
              inner join obs o on o.encounter_id=e.encounter_id 
              where e.encounter_type=6 and  e.location_id=3 and e.voided=0 and p.voided=0 and  o.concept_id=1268  and o.value_coded in(1256,1257,1267)
              union
              select p.patient_id,o.obs_datetime data_tb,e.encounter_id from patient p 
              inner join encounter e on p.patient_id=e.patient_id 
              inner join obs o on o.encounter_id=e.encounter_id 
              where e.encounter_type=53 and  e.location_id=3 and e.voided=0 and p.voided=0 and  o.concept_id=42 
              union
              select p.patient_id,e.encounter_datetime data_tb,e.encounter_id from patient p 
              inner join encounter e on p.patient_id=e.patient_id 
              inner join obs o on o.encounter_id=e.encounter_id 
              where e.encounter_type=6 and  e.location_id=3 and e.voided=0 and p.voided=0 and  o.concept_id=1406  and o.value_coded =42
              )tpt 
          ...
          left join 
           (
             select tptFinal.patient_id,tptFinal.dataInicioTPI  from ( 
              ...
              and e.encounter_type in (6,9) and e.location_id=3 
              union
              ...
              and estadoProfilaxia.concept_id = 165308 and estadoProfilaxia.value_coded = 1256  
              and e.encounter_type=53 and e.location_id=3 
              ) tptFinal  
              )tptFinal  on tptFinal.patient_id=tx_new.patient_id
              WHERE ((tx_new.art_start_date BETWEEN  date_sub(date(concat('2023','-12','-21')), interval 24 MONTH) and  date_sub(date(concat('2023','-06','-20')), interval 12 MONTH)) 
                        OR (tx_new.art_start_date BETWEEN date_sub(date(concat('2023','-12','-21')), interval 36 MONTH) and  date_sub(date(concat('2023','-06','-20')), interval 24 MONTH))
                        OR (tx_new.art_start_date BETWEEN  date_sub(date(concat('2023','-12','-21')), interval 48 MONTH) and  date_sub(date(concat('2023','-06','-20')), interval 36 MONTH)))
      ...
      left join
       ...
       left join
       (
     select primeiroCd4.patient_id,primeiroCd4.data_primeiro_cd4_12_meses,primeiroCd4.primeiro_resultado_cd4_12_meses,min(segundoCd4.data_segundo_cd4_12_meses) data_segundo_cd4_12_meses,segundoCd4.resultado_segundo_cd4_12_meses, date_add(tx_new.art_start_date, interval 33 day), date_add(tx_new.art_start_date, interval 12 month)  
      from 
      (
        SELECT patient_id, MIN(art_start_date) art_start_date FROM 
         ( 
      ...
      (
           ...
           if((gravidaLactante.data_gravida_lactante BETWEEN date_add(tx_new.art_start_date, interval 3 month) and date_add(tx_new.art_start_date, interval 9 month)) and  gravidaLactante.value_coded=1065,'Sim','Não') gravida_lactante 
         from 
         (
         SELECT patient_id, MIN(art_start_date) art_start_date FROM 
         ( 
      ...
      ( 
       ...
       select tb.patient_id,tb.data_tb from 
                ...
                select p.patient_id,e.encounter_datetime as data_tb  from patient p 
                    ...
                    where e.encounter_type in(6) and o.concept_id=23761 and o.value_coded=1065  and e.location_id=3 
          ...
          left join
            (
                    ...
                    (
                         ...
                         inner join encounter e on p.patient_id=e.patient_id 
                         inner join obs o on o.encounter_id=e.encounter_id 
                         where e.encounter_type in(6) and o.concept_id=23758  and e.location_id=3 and o.value_coded in(1065,1066)
                         and e.voided=0 and p.voided=0 and o.voided=0 
                        -- order by p.patient_id,e.encounter_datetime
            ...
            from( 
             ...
             )pf12Meses on pf12Meses.patient_id=coorteFinal.patient_id
             left join
             (
                select  mds.patient_id,
                        mds.art_start_date,
            ...
            (
                ...
                (
                    ...
                    select p.patient_id,e.encounter_datetime consultas_pb_imc,o.concept_id  from 
                      ...
                      where e.encounter_type=6   and e.location_id=3 and e.voided=0 and p.voided=0 and e.voided=0 and o.concept_id is not null
            ...
            )todasConsultasPA on todasConsultasPA.patient_id=coorteFinal.patient_id
            left join
            (
                           ...
                           union
                            ...
                            SELECT tx_new.patient_id,tx_new.art_start_date
                              FROM 
                                 ...
                                 art_start GROUP BY patient_id 
                             ) tx_new --WHERE art_start_date BETWEEN  date_sub(date(concat('2023','-12','-21')), interval 48 MONTH) and   date_sub(date(concat('2023','-12','-21')), interval 24 month)
                           )tx_new
                            inner join
                            ( 
          ...
          left join
              ...
              select coorte12meses_final.patient_id 
                from( 
                 ...
                 )activo12Meses on activo12Meses.patient_id=coorteFinal.patient_id
                 where coorteFinal.tipo_coorte in(12,24,36)

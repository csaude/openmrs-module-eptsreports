...
select * from (
        ...
        select 
           ...
           floor(datediff(coorte36Meses.art_start_date,p.birthdate)/365) as idade,
                      ...
                      -- COLUNAS 36 MESES
           DATE_FORMAT(DATE(variaveisDatasCoorte36.data_primeiro_pedido_cv_36_meses),'%d/%m/%Y') data_primeiro_vc_36_meses,
           DATE_FORMAT(DATE(max(variaveisDatasCoorte36.data_primeiro_resultado_cv_36_meses)),'%d/%m/%Y') data_primeiro_resultado_cv_36_meses,
           variaveisDeTextoCoorte36.resultado_cv_36_meses resultado_cv_36_meses ,
           DATE_FORMAT(DATE(variaveisDatasCoorte36.data_primeiro_cd4_36_meses),'%d/%m/%Y') data_primeiro_cd4_36_meses,
           variaveisDeTextoCoorte36.primeiro_resultado_cd4_36_meses primeiro_resultado_cd4_36_meses,
           variaveisDeTextoCoorte36.nivel_adesao_apss_36_meses ,
           variaveisDeTextoCoorte36.gravida_lactante_36_meses,
           variaveisDeTextoCoorte36.tipo_estadio_36_meses,

           if(variaveisDatasCoorte36.data_tb_36_meses is null or variaveisDatasCoorte36.data_tb_36_meses='' ,'Não','Sim') tb_36_meses,
           DATE_FORMAT(DATE(variaveisDatasCoorte36.data_registo_primeiro_mdc_36_meses),'%d/%m/%Y') data_registo_primeiro_mdc_36_meses,
           variaveisDatasCoorte36.data_inicio_mds_36_meses,
           ...
           variaveisDeTextoCoorte36.mdc_simtomas_tb_36_meses mdc_simtomas_tb_36_meses,
           variaveisDeTextoCoorte36.pf_36_meses,
           variaveisDeTextoCoorte36.tpt_36_meses,
           variaveisDeTextoCoorte36.mds_consultas_pb_imc_36_meses,
           variaveisDeTextoCoorte36.pa_36_meses,
          
           if(variaveisDeTextoCoorte36.total_consultas_fc_36_meses is not null, variaveisDeTextoCoorte36.total_consultas_fc_36_meses,'0')  total_consultas_fc_36_meses,
           if(variaveisDeTextoCoorte36.total_apss_36_meses is not null, variaveisDeTextoCoorte36.total_apss_36_meses,'0')  total_consultas_apss_36_meses,

           variaveisDeTextoCoorte36.via_36_meses,
           variaveisDeTextoCoorte36.via_positivo_36_meses,
             case 
             when variaveisDeTextoCoorte36.estado_permanencia_36_meses = 1 then 'ABANDONO' 
             when variaveisDeTextoCoorte36.estado_permanencia_36_meses = 2 then 'OBITO' 
             when variaveisDeTextoCoorte36.estado_permanencia_36_meses = 3 then 'SUSPENSO' 
             when variaveisDeTextoCoorte36.estado_permanencia_36_meses = 4 then 'TRANSFERIDO PARA' 
             when (variaveisDeTextoCoorte36.activo is not null) then 'ACTIVO' 
             else 'N/A'
             ...
             when A.valor4 is not null  then A.valor4
                          ...
                          -- COLUNAS 24 MESES
           DATE_FORMAT(DATE(variaveisDatasCoorte24.data_primeiro_pedido_cv_24_meses),'%d/%m/%Y') data_primeiro_vc_24_meses,
           DATE_FORMAT(DATE(max(variaveisDatasCoorte24.data_primeiro_resultado_cv_24_meses)),'%d/%m/%Y') as  data_primeiro_resultado_cv_24_meses,
           variaveisDeTextoCoorte24.resultado_cv_24_meses resultado_cv_24_meses ,
           variaveisDeTextoCoorte24.primeiro_resultado_cd4_24_meses primeiro_resultado_cd4_24_meses ,
           variaveisDeTextoCoorte24.nivel_adesao_apss_24_meses nivel_adesao_apss_24_meses,
           variaveisDeTextoCoorte24.gravida_lactante_24_meses  gravida_lactante_24_meses,

            case 
            when variaveisDeTextoCoorte24.tipo_estadio_24_meses=:location  then 'Estadio III' 
            when variaveisDeTextoCoorte24.tipo_estadio_24_meses=4  then 'Estadio IV' 
            end as tipo_estadio_24_meses,  
            
           variaveisDeTextoCoorte24.tb_24_meses tb_24_meses,
           DATE_FORMAT(DATE(variaveisDatasCoorte24.data_registo_primeiro_mdc_24_meses),'%d/%m/%Y') data_registo_primeiro_mdc_24_meses,
           DATE_FORMAT(DATE(variaveisDatasCoorte24.data_inicio_mds_24_meses),'%d/%m/%Y') data_inicio_mds_24_mesess,
           ...
           variaveisDeTextoCoorte24.mdc_simtomas_tb_24_meses mdc_simtomas_tb_24_meses,
           variaveisDeTextoCoorte24.pf_24_meses pf_24_meses,
           variaveisDeTextoCoorte24.tpt_24_meses tpt_24_meses,
           variaveisDeTextoCoorte24.mds_consultas_pb_imc_24_meses mds_consultas_pb_imc_24_meses,
           variaveisDeTextoCoorte24.pa_24_meses pa_24_meses,
           
           if(variaveisDeTextoCoorte24.total_fc_24_meses is not null, variaveisDeTextoCoorte24.total_fc_24_meses, '0') total_consultas_fc_24_meses,
           if(variaveisDeTextoCoorte24.total_apss_24_meses is not null, variaveisDeTextoCoorte24.total_apss_24_meses,'0')  total_consultas_apss_24_meses,

             variaveisDeTextoCoorte24.via_24_meses via_24_meses,
             variaveisDeTextoCoorte24.via_positivo_24_meses via_positivo_24_meses,
             
             case 
             when variaveisDeTextoCoorte24.estadioDePermanencia24Meses = 1 then 'ABANDONO' 
             when variaveisDeTextoCoorte24.estadioDePermanencia24Meses = 2 then 'OBITO' 
             when variaveisDeTextoCoorte24.estadioDePermanencia24Meses = 3 then 'SUSPENSO' 
             when variaveisDeTextoCoorte24.estadioDePermanencia24Meses = 4 then 'TRANSFERIDO PARA' 
             when (variaveisDeTextoCoorte24.activo24Meses is not null) then 'ACTIVO' 
             else 'N/A'
        ...
        (
           SELECT tr.patient_id, tr.data_transferencia from  
              (
                ...
                ( 
                select states.patient_id,states.patient_program_id,min(states.minStateDate) as minStateDate,states.program_id,states.state 
                from  
                ( 
        ...
        )coorte24Meses on coorte36Meses.patient_id=coorte24Meses.patient_id
        ...
        )coorte12Meses on coorte36Meses.patient_id=coorte12Meses.patient_id
          where trasferedIn.patient_id is null and coorte12Meses.patient_id is null and coorte24Meses.patient_id is null
     
      )coorte36Meses 
             inner join person p on p.person_id=coorte36Meses.patient_id

             left join (
           

 select tmp.patient_id, 
                       MAX(CASE WHEN tmp.source = 't1' then tmp.value END) as data_primeiro_pedido_cv_36_meses, 
                       MAX(CASE WHEN tmp.source = 't2' then tmp.value END) as data_primeiro_resultado_cv_36_meses,
                       MAX(CASE WHEN tmp.source = 't8' then tmp.value END) as data_registo_primeiro_mdc_36_meses,
                       MAX(CASE WHEN tmp.source = 't9' then tmp.value END) as data_inicio_mds_36_meses,
                       MAX(CASE WHEN tmp.source = 't22' then tmp.value END) as data_primeiro_cd4_36_meses,
                       MAX(CASE WHEN tmp.source = 't10' then tmp.value END) as data_tb_36_meses
                       from (
    select primeiroPedidoCV36Meses.patient_id,primeiroPedidoCV36Meses.data_primeiro_pedido_cv_36_meses value, 't1' as source
                        from   
                        (
		...
		union
			     select coorte36Meses.patient_id, primeiroResultadoPedidoCV36Meses.data_primeiro_resultado_cv_36_meses as value, 't2' as source
         from 
         (
         SELECT tx_new.patient_id,tx_new.art_start_date
           FROM 
            ...
            left join
         (
           select p.patient_id,e.encounter_datetime data_primeiro_resultado_cv_36_meses,12 tipo_coorte_12, 24 tipo_coorte_24, 36 tipo_coorte_36
                from patient p   
                inner join encounter e on p.patient_id = e.patient_id   
                inner join obs o on o.encounter_id = e.encounter_id   
                where p.voided = 0 
                ...
                and e.location_id=:location 
         )primeiroResultadoPedidoCV36Meses on primeiroResultadoPedidoCV36Meses.patient_id=coorte36Meses.patient_id
         and primeiroResultadoPedidoCV36Meses.data_primeiro_resultado_cv_36_meses BETWEEN date_add(coorte36Meses.art_start_date, interval 24 month) 
         and  date_add(coorte36Meses.art_start_date, interval 36 month) 

		union

 select coorte36Meses.patient_id, primeiroCd436Meses.data_primeiro_cd4_36_meses, 't22' as source
         from 
         (
         SELECT tx_new.patient_id,tx_new.art_start_date
           FROM 
            ...
            left join
       (
            select p.patient_id,min(o.obs_datetime) data_primeiro_cd4_36_meses,o.value_numeric primeiro_resultado_cd4_36_meses,12 tipo_coorte_12, 24 tipo_coorte_24,36 tipo_coorte_36
              from patient p   
              inner join encounter e on p.patient_id = e.patient_id   
              inner join obs o on o.encounter_id = e.encounter_id   
              where p.voided = 0 and e.voided = 0  and o.voided = 0     
       ...
       )primeiroCd436Meses on primeiroCd436Meses.patient_id=coorte36Meses.patient_id 
       and primeiroCd436Meses.data_primeiro_cd4_36_meses BETWEEN date_add(coorte36Meses.art_start_date, interval 24 month) and date_add(coorte36Meses.art_start_date, interval 36 month) 

		union
		
             SELECT tx_new.patient_id,min(primeiroMdc.data_registo_primeiro_mdc) data_registo_primeiro_mdc_36_meses, 't8' as source
           FROM 
              (
              SELECT patient_id, MIN(art_start_date) art_start_date FROM 
              ( 
      ...
      select primeiroMdc.patient_id,primeiroMdc.data_mdc data_registo_primeiro_mdc from 
          ...
          select p.patient_id,e.encounter_datetime as data_mdc  from patient p 
              ...
              union
               ...
               select coorte36Meses.patient_id, inicioMds36Meses.data_inicio_mds_36_meses, 't9' as source
         from 
         (
         SELECT tx_new.patient_id,tx_new.art_start_date
           FROM 
            ...
            left join
       (
              select p.patient_id,e.encounter_datetime data_inicio_mds_36_meses,12 tipo_coorte_12, 24 tipo_coorte_24,36 tipo_coorte_36
              from patient p 
              join encounter e on p.patient_id=e.patient_id 
              join obs grupo on grupo.encounter_id=e.encounter_id 
              join obs o on o.encounter_id=e.encounter_id 
              ...
              and grupo.obs_id=o.obs_group_id 
              and grupo.obs_id=obsEstado.obs_group_id 
       )inicioMds36Meses on inicioMds36Meses.patient_id=coorte36Meses.patient_id
       and inicioMds36Meses.data_inicio_mds_36_meses BETWEEN date_add(coorte36Meses.art_start_date, interval 24 month) and date_add(coorte36Meses.art_start_date, interval 36 month) 

       union

          select coorte36Meses.patient_id, tb36Meses.data_tb_36_meses, 't10' as source
         from 
         (
         SELECT tx_new.patient_id,tx_new.art_start_date
           FROM 
            ...
            left join
       (
        select tb36Meses.patient_id,tb36Meses.data_tb_36_meses,tb36Meses.data_tb_36_meses  tb_36_meses,12 tipo_coorte_12, 24 tipo_coorte_24,36 tipo_coorte_36 from 
              (
       ...
       ) tb36Meses on tb36Meses.patient_id=coorte36Meses.patient_id
            and tb36Meses.data_tb_36_meses BETWEEN date_add(coorte36Meses.art_start_date, interval 24 month) and date_add(coorte36Meses.art_start_date, interval 36 month) 

     )tmp group by tmp.patient_id

    ) variaveisDatasCoorte36 on variaveisDatasCoorte36.patient_id = coorte36Meses.patient_id

             left join (
                   select tmp.patient_id,
            	       MAX(CASE WHEN tmp.source = 't3' then tmp.value END) as resultado_cv_36_meses,
                       MAX(CASE WHEN tmp.source = 't4' then tmp.value END) as primeiro_resultado_cd4_36_meses,
                       MAX(CASE WHEN tmp.source = 't5' then tmp.value END) as nivel_adesao_apss_36_meses,
                       MAX(CASE WHEN tmp.source = 't6' then tmp.value END) as gravida_lactante_36_meses,
                       MAX(CASE WHEN tmp.source = 't7' then tmp.value END) as tipo_estadio_36_meses,
                       MAX(CASE WHEN tmp.source = 't11' then tmp.value END) as mdc_simtomas_tb_36_meses,
                       MAX(CASE WHEN tmp.source = 't12' then tmp.value END) as pf_36_meses,
                       MAX(CASE WHEN tmp.source = 't13' then tmp.value END) as tpt_36_meses,
                       MAX(CASE WHEN tmp.source = 't14' then tmp.value END) as mds_consultas_pb_imc_36_meses,
                       MAX(CASE WHEN tmp.source = 't15' then tmp.value END) as pa_36_meses,
                       MAX(CASE WHEN tmp.source = 't16' then tmp.value END) as total_consultas_fc_36_meses,
	                   MAX(CASE WHEN tmp.source = 't17' then tmp.value END) as total_apss_36_meses,
	                   MAX(CASE WHEN tmp.source = 't18' then tmp.value END) as via_36_meses,
	                   MAX(CASE WHEN tmp.source = 't19' then tmp.value END) as via_positivo_36_meses,
	                   MAX(CASE WHEN tmp.source = 't20' then tmp.value END) as estado_permanencia_36_meses,
	                   MAX(CASE WHEN tmp.source = 't21' then tmp.value END) as activo
                       from (

             SELECT tx_new.patient_id,
                          if(cv.comments is not null, CONCAT(cv.resultado_cv_36_meses,' ',cv. comments),cv.resultado_cv_36_meses) value,
                          't3' as source
                       FROM 
                          (
                          SELECT patient_id, MIN(art_start_date) art_start_date FROM 
              ...
              case o.value_coded 
                    ...
                    select p.patient_id,o.obs_datetime data_primeiro_resultado_cv_36_meses,
	                    o.value_numeric as resultado_cv_36_meses, o.comments
	                    from patient p   
	                    inner join encounter e on p.patient_id = e.patient_id   
	                    inner join obs o on o.encounter_id = e.encounter_id   
	                    where p.voided = 0 and e.voided = 0  and o.voided = 0
                    ...
                    union
                    	      ...
                    	      select coorte36Meses.patient_id, primeiroCd436Meses.primeiro_resultado_cd4_36_meses, 't4' as source
         from 
         (
         SELECT tx_new.patient_id,tx_new.art_start_date
           FROM 
       ...
       and primeiroCd436Meses.primeiro_resultado_cd4_36_meses BETWEEN date_add(coorte36Meses.art_start_date, interval 24 month) and date_add(coorte36Meses.art_start_date, interval 36 month)
	...
	SELECT patient_id, count(CASE WHEN answer = 'Sim' THEN 1 ELSE NULL END) as numeroDeSims FROM (
                                                  select tx_new.patient_id,
            if(gravidaLactante.value_coded=1065 and gravidaLactante.data_gravida_lactante BETWEEN date_add(tx_new.art_start_date, interval 24 month) and date_add(tx_new.art_start_date, interval 36 month) ,'Sim','Não') answer
                            from 
                            (
                            SELECT patient_id, MIN(art_start_date) art_start_date FROM 
                            ( 
             ...
             select f.patient_id,case when f.tipoEstadio36Meses=:location then 'Estadio III' when f.tipoEstadio36Meses=4 then 'Estadio IV' end as valor, 't7' as source
                         from
                         (
                             select tx_new.patient_id,
                            tx_new.art_start_date,
                            max(estadiamentoClinico36Meses.encounter_datetime) encounter_datetime, 
                            estadiamentoClinico36Meses.value_coded,
                            estadiamentoClinico36Meses.tipoEstadio36Meses,
                            date_add(tx_new.art_start_date, interval 24 month), 
                             date_add(tx_new.art_start_date, interval 36 month)
                     from
                     (
                ...
                left join
                (
                select estadiamentoClinico36Meses.patient_id, estadiamentoClinico36Meses.encounter_datetime encounter_datetime,estadiamentoClinico36Meses.value_coded,estadiamentoClinico36Meses.tipoEstadio36Meses
                from( 
                    select estadio4.patient_id,estadio4.encounter_datetime,o.value_coded, 4 as tipoEstadio36Meses 
                    from( 
                    ...
                    select estadio3.patient_id, estadio3.encounter_datetime,o.value_coded, 3 as tipoEstadio36Meses 
                    from( 
                        select p.patient_id,e.encounter_datetime encounter_datetime 
                        from patient p 
                            inner join encounter e on p.patient_id=e.patient_id 
                    ...
                    )estadiamentoClinico36Meses order by estadiamentoClinico36Meses.patient_id, estadiamentoClinico36Meses.encounter_datetime 
                    )estadiamentoClinico36Meses on estadiamentoClinico36Meses.patient_id=tx_new.patient_id
                    where estadiamentoClinico36Meses.encounter_datetime BETWEEN date_add(tx_new.art_start_date, interval 24 month) and date_add(tx_new.art_start_date, interval 36 month)
                    group by tx_new.patient_id order by tx_new.patient_id,estadiamentoClinico36Meses.encounter_datetime,estadiamentoClinico36Meses.tipoEstadio36Meses
                    )f
           ...
           select * from (
             select  tx_new.patient_id,
               ...
               SELECT patient_id, if(ISNULL(data_inicio_tpt_24_meses),'Não', 'Sim') as tpt_36_meses,
                   't13' as source
                   FROM (
			SELECT * FROM (
             ...
             select  pbImc36Meses.patient_id,if(count(pbImc36Meses.consultas_pb_imc_36_meses)=count(pbImc36Meses.consultas_pb_imc_36_meses_2),'Sim','Não') consultas_pb_imc_36_meses,'t14' as source
               from 
                    (
                ...
                (
                 ...
                 )todasConsultas36MesesPA

                 union

                 
            SELECT consultas36Meses.patient_id, count(consultas36Meses.todas_consultas_fc_36_meses) total_consultas_fc_36_meses, 't16' as source
              FROM 
               (
        ...
        union
                     ...
                     SELECT consultas36Meses.patient_id, count(consultas36Meses.todas_consultas_fc_36_meses) total_consultas_apss_36_meses, 't17' as source
                   FROM    
                       (
                      select p.patient_id,e.encounter_datetime todas_consultas_fc_36_meses  from 
                      patient p 
			...
			union
                     ...
                     select tx_new.patient_id,
                        if(p.gender='M','N/A', 
                        if((p.gender='F') and (via36Meses.encounter_datetime BETWEEN date_add(tx_new.art_start_date, interval 24 month) and date_add(tx_new.art_start_date, interval 36 month)),'Sim','Não')) via_36_meses,
                        't18' as source
                ...
                left join
                (
                select via36Meses.patient_id, via36Meses.encounter_datetime encounter_datetime
                from( 
                        select p.patient_id,e.encounter_datetime encounter_datetime 
                        from patient p 
                            inner join encounter e on p.patient_id=e.patient_id 
                        ...
                        and e.location_id=:location 
                    )via36Meses order by via36Meses.patient_id, via36Meses.encounter_datetime 
                   )via36Meses on via36Meses.patient_id=tx_new.patient_id
                   inner join person p on p.person_id=tx_new.patient_id
                   ...
                   union
                    ...
                    select tx_new.patient_id,
                        if(p.gender='M','N/A', 
                        if((p.gender='F') and (viaPositivo36Meses.encounter_datetime BETWEEN date_add(tx_new.art_start_date, interval 24 month) and date_add(tx_new.art_start_date, interval 36 month)),'Sim','Não')) via_positivo_36_meses,
                        't19' as source
                ...
                from( 
                   ...
                   )viaPositivo36Meses on viaPositivo36Meses.patient_id=tx_new.patient_id
                   inner join person p on p.person_id=tx_new.patient_id

			union

			select f.*, 't20' as source from 
                   (  
              ...
              union
                  ...
                  select coorte12meses_final.patient_id, coorte12meses_final.patient_id as patient_id, 't21' as source
                from( 
                 ...
                 WHERE  ((data_estado is null or ((data_estado is not null) and  data_fila>data_estado))  and date_add(data_usar, interval 59 day) >=date_add(coorte12meses_final.data_inicio, interval 36 month)) 

                             
                )tmp
                 group by tmp.patient_id
             )variaveisDeTextoCoorte36 on variaveisDeTextoCoorte36.patient_id = coorte36Meses.patient_id
       ...
       (
          ...
          )primeiroMds36Meses on primeiroMds36Meses.patient_id=coorte36Meses.patient_id 
       ...
       (
        ...
        left join 
        (
          select tmp.patient_id, MAX(CASE WHEN tmp.source = 't1' then tmp.value END) as data_primeiro_pedido_cv_24_meses,
                       MAX(CASE WHEN tmp.source = 't2' then tmp.value END) as data_primeiro_resultado_cv_24_meses,
                       MAX(CASE WHEN tmp.source = 't9' then tmp.value END) as data_registo_primeiro_mdc_24_meses,
                       MAX(CASE WHEN tmp.source = 't10' then tmp.value END) as data_inicio_mds_24_meses 
                               from (
      ---primeiroPedidoCV24Meses
      
          SELECT tx_new.patient_id, max(primeiroPedidoCV24Meses.data_primeiro_pedido_cv_24_meses) value, 't1' as source
                       FROM 
                          (
                          SELECT patient_id, MIN(art_start_date) art_start_date FROM 
                          ( 
                        ...
                        (
                           ...
                           ---primeiroResultadoPedidoCV24Meses
                           
          select coorte36Meses.patient_id,primeiroResultadoPedidoCV24Meses.data_primeiro_resultado_cv_24_meses, 't2' as source
               from 
               (
               ...
               SELECT tx_new.patient_id,tx_new.art_start_date
                 ...
                 (
                   select p.patient_id,e.encounter_datetime data_primeiro_resultado_cv_24_meses,12 tipo_coorte_12, 24 tipo_coorte_24
                        ...
                        and e.encounter_type=6 
                        and e.location_id=:location 
                 )primeiroResultadoPedidoCV24Meses on primeiroResultadoPedidoCV24Meses.patient_id=coorte36Meses.patient_id 
                  and (primeiroResultadoPedidoCV24Meses.data_primeiro_resultado_cv_24_meses>=date_add(coorte36Meses.art_start_date, interval 12 month)) 
                  and (primeiroResultadoPedidoCV24Meses.data_primeiro_resultado_cv_24_meses<=date_add(coorte36Meses.art_start_date, interval 24 month)) 

                  union

            --primeiroMdc24Meses

                       SELECT tx_new.patient_id, min(primeiroMdc.data_registo_primeiro_mdc) data_registo_primeiro_mdc_24_meses, 't9' as source
           FROM 
              (
              SELECT patient_id, MIN(art_start_date) art_start_date FROM 
              ( 
      ...
      select primeiroMdc.patient_id,primeiroMdc.data_mdc data_registo_primeiro_mdc from 
          ...
          select coorte36Meses.patient_id,inicioMds24Meses.data_inicio_mds_24_meses, 't10' as source
           from 
           (
       ...
       (
              ...
              and grupo.obs_id=o.obs_group_id 
              and grupo.obs_id=obsEstado.obs_group_id 
       )inicioMds24Meses on inicioMds24Meses.patient_id=coorte36Meses.patient_id
       and inicioMds24Meses.data_inicio_mds_24_meses BETWEEN date_add(coorte36Meses.art_start_date, interval 12 month) and date_add(coorte36Meses.art_start_date, interval 24 month) 
            
                 )tmp
                 group by tmp.patient_id
        ) variaveisDatasCoorte24 on variaveisDatasCoorte24.patient_id = coorte36Meses.patient_id

        left join(

               
  select tmp.patient_id,
             MAX(CASE WHEN tmp.source = 't3' then tmp.value END) as resultado_cv_24_meses,
             MAX(CASE WHEN tmp.source = 't4' then tmp.value END) as primeiro_resultado_cd4_24_meses,    
             MAX(CASE WHEN tmp.source = 't5' then tmp.value END) as nivel_adesao_apss_24_meses,
                       MAX(CASE WHEN tmp.source = 't6' then tmp.value END) as gravida_lactante_24_meses,
                       MAX(CASE WHEN tmp.source = 't7' then tmp.value END) as tipo_estadio_24_meses,
                       MAX(CASE WHEN tmp.source = 't8' then tmp.value END) as tb_24_meses,
                       MAX(CASE WHEN tmp.source = 't11' then tmp.value END) as mdc_simtomas_tb_24_meses,
                       MAX(CASE WHEN tmp.source = 't12' then tmp.value END) as pf_24_meses,
                       MAX(CASE WHEN tmp.source = 't13' then tmp.value END) as tpt_24_meses,
                       MAX(CASE WHEN tmp.source = 't14' then tmp.value END) as mds_consultas_pb_imc_24_meses,
                       MAX(CASE WHEN tmp.source = 't15' then tmp.value END) as pa_24_meses,
                       MAX(CASE WHEN tmp.source = 't16' then tmp.value END) as total_fc_24_meses,
                       MAX(CASE WHEN tmp.source = 't17' then tmp.value END) as total_apss_24_meses,
                       MAX(CASE WHEN tmp.source = 't18' then tmp.value END) as via_24_meses,
                       MAX(CASE WHEN tmp.source = 't19' then tmp.value END) as via_positivo_24_meses,
                       MAX(CASE WHEN tmp.source = 't20' then tmp.value END) as estadioDePermanencia24Meses,
                       MAX(CASE WHEN tmp.source = 't21' then tmp.value END) as activo24Meses
                       
                               from (
   --adesaoApss24Meses
                         select semAdesao.patient_id,
                       if(maAdesao.encounter_3 is not null,'Não',if(semAdesao.encounter_1=boaAdesao.encounter_2, 'Sim',' ')) value, 't5' as source
                   from  person p inner join
                   (
                     select tx_new.patient_id,tx_new.art_start_date, totalApss.data_adesao_apss_24_meses_1, count(totalApss.encounter_1) encounter_1
              from 
	...
	SELECT patient_id, count(CASE WHEN answer = 'Sim' THEN 1 ELSE NULL END) as numeroDeSims FROM (
        ...
        select * from (
            ...
            from( 
                ...
                --tb24Meses
                    ...
                    select coorte36Meses.patient_id,tb24Meses.tb_24_meses, 't8' as source
               from 
               (
       ...
       ) tb24Meses on tb24Meses.patient_id=coorte36Meses.patient_id  
            and tb24Meses.data_tb_24_meses BETWEEN date_add(coorte36Meses.art_start_date, interval 12 month) and date_add(coorte36Meses.art_start_date, interval 24 month) 
    ...
    select  tx_new.patient_id,
            ...
            't19' as source
              ...
              case o.value_coded 
                   ...
                   ---primeiroCd424Meses
                      ...
                      select final.patient_id, obsCd4.value_numeric value, 't4' as source
                 from
                 (
                  select tx_new.patient_id,
                         tx_new.art_start_date, 
              ...
              union
                ...
                --todasConsultasFichaClinica24Meses

                  SELECT consultas24Meses.patient_id, count(consultas24Meses.todas_consultas_fc_24_meses) total_fc_24_meses, 't16' as source
              FROM 
      ...
      --todasConsultasFichaApss24Meses
               
             SELECT consultas24Meses.patient_id, count(consultas24Meses.todas_consultas_fc_24_meses) total_apss_24_meses, 't17' as source
           FROM 
       ...
       Select B7.patient_id, 1 tipo_saida from 
                             ...
                             select transferidopara.patient_id, 4 tipo_saida 
                               ...
                               select transferido.patient_id,max(transferido.data_transferidopara) data_transferidopara
                                 ...
                                 SELECT tx_new.patient_id,tx_new.art_start_date
                                         ...
                                         select coorte12meses_final.patient_id,coorte12meses_final.patient_id, 't21' as source 
                from( 
                    select inicio_fila_seg_prox.*,
                        data_encountro data_usar_c, 
                          data_proximo_lev data_usar 
               ...
               ) variaveisDeTextoCoorte24 on variaveisDeTextoCoorte24.patient_id = coorte36Meses.patient_id
       left join
       (
          ...
          )primeiroMds24Meses on primeiroMds24Meses.patient_id=coorte36Meses.patient_id 
      ...
      select primeiroMdc.patient_id,primeiroMdc.data_mdc data_registo_primeiro_mdc from 
          ...
          select p.patient_id,e.encounter_datetime as data_mdc  from patient p 
              ...
              group by primeiroMdc.patient_id
                 ...
                 group by tmp.patient_id
       )variaveisDatasCoorte12 on variaveisDatasCoorte12.patient_id=coorte36Meses.patient_id  
       left join(
          select tmp.patient_id,
            ...
            select primeiroCd4.patient_id,
             ...
             (
              ...
              select semAdesao.patient_id,
				...
				select f.patient_id, if(f.numeroDeSims>=1, 'Sim', 'Não') as valor10, 
				                     't6' as source from (
				SELECT patient_id, count(CASE WHEN valor10 = 'Sim' THEN 1 ELSE NULL END) as numeroDeSims FROM (
                    select tx_new.patient_id,
                ...
                union
                    ...
                    (
                     ...
                     select mds.patient_id,
                       ...
                       if(((estadiamentoClinico.encounter_datetime BETWEEN mds.data_inicio_mds and date_add(mds.data_inicio_mds, interval 12 month)) and (mds.data_inicio_mds BETWEEN mds.art_start_date and date_add(mds.art_start_date, interval 12 month)) and estadiamentoClinico.tipoEstadio=:location),'Estadio III',
       ...
       ) variaveisDeTextoCoorte12 on variaveisDeTextoCoorte12.patient_id=coorte36Meses.patient_id

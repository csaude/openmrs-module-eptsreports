           ...
           if(todasConsultasFichaClinica36Meses.total_apss_36_meses is not null, todasConsultasFichaClinica36Meses.total_apss_36_meses,'0')  total_consultas_fc_36_meses,
       ...
       left join 
          ...
          )primeiroPedidoCV36Meses on primeiroPedidoCV36Meses.patient_id=coorte36Meses.patient_id
       ...
       (
        ...
        )resultadoCVPrimeiro36Meses on resultadoCVPrimeiro36Meses.patient_id=coorte36Meses.patient_id 
       ...
       (
        ...
        )adesaoApss36Meses on adesaoApss36Meses.patient_id=coorte36Meses.patient_id       
      ...
      (
          select tx_new.patient_id,tx_new.art_start_date,
                    ...
                    12 tipo_coorte_12, 24 tipo_coorte_24,36 tipo_coorte_36
                           ...
                           and p.gender='F' 
        )gravidaLactante36Meses on gravidaLactante36Meses.patient_id=coorte36Meses.patient_id        
      
        left join
       (
             select f.patient_id,case when f.tipoEstadio36Meses=3 then 'Estadio III' when f.tipoEstadio36Meses=4 then 'Estadio IV' end as valor, 12 tipo_coorte_12, 24 tipo_coorte_24,36 tipo_coorte_36
                         from
                         (
       ...
       )estadiamentoClinico36Meses on estadiamentoClinico36Meses.patient_id=coorte36Meses.patient_id 
       ...
       (
        ...
        left join
       (
             SELECT tx_new.patient_id,tx_new.art_start_date, min(primeiroMdc.data_registo_primeiro_mdc) data_registo_primeiro_mdc_36_meses, 12 tipo_coorte_12, 24 tipo_coorte_24,36 tipo_coorte_36
           FROM 
              (
              SELECT patient_id, MIN(art_start_date) art_start_date FROM 
              ( 
      ...
      select primeiroMdc.patient_id,primeiroMdc.data_mdc data_registo_primeiro_mdc from 
       ...
       )primeiroMdc36Meses on primeiroMdc36Meses.patient_id=coorte36Meses.patient_id 
       ...
       (
          ...
          from    
           ...
           group by tx_new.patient_id
            ...
            )tbSinthoms36Meses on tbSinthoms36Meses.patient_id=coorte36Meses.patient_id 
        ...
        group by consultas36Meses.patient_id
        )todasConsultasFichaClinica36Meses on todasConsultasFichaClinica36Meses.patient_id=coorte36Meses.patient_id 
                ...
                where consultas36Meses.todas_consultas_fc_36_meses BETWEEN date_add(tx_new.art_start_date, interval 24 month)  and date_add(tx_new.art_start_date, interval 36 month)
                group by consultas36Meses.patient_id
                )todasConsultasFichaApss36Meses on todasConsultasFichaApss36Meses.patient_id=coorte36Meses.patient_id 
                left join
                (
                     select tx_new.patient_id,
                        tx_new.art_start_date, 
                ...
                )via36Meses on via36Meses.patient_id=coorte36Meses.patient_id 
                left join
                (
                    select tx_new.patient_id,
                        tx_new.art_start_date, 
                ...
                from( 
                 ...
                 --group by tx_new.patient_id order by tx_new.patient_id,via.encounter_datetime
                )viaPositivo36Meses on viaPositivo36Meses.patient_id=coorte36Meses.patient_id  

                  left join
                  (
                   select f.*,12 tipo_coorte_12, 24 tipo_coorte_24, 36 tipo_coorte_36 from 
                   (  
                  ...
                  ) estadioDePermanencia36Meses on  estadioDePermanencia36Meses.patient_id=coorte36Meses.patient_id 
                  
                      left join
                  (
              select coorte12meses_final.patient_id,12 tipo_coorte_12, 24 tipo_coorte_24, 36 tipo_coorte_36
                from( 
                 ...
                 )activo36Meses on activo36Meses.patient_id=coorte36Meses.patient_id
                                     left join
       (

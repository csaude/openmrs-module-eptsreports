    ...
    ( select 
         -- COLUNAS 36 MESES
          concat(coorteFinal.tipo_coorte,' ','meses') as tipo_coorte,
           ...
           gravidaLactante36Meses.answer  gravida_lactante_36_meses,
            case 
            when estadiamentoClinico36Meses.tipoEstadio36Meses=3 then 'Estadio III' 
            when estadiamentoClinico36Meses.tipoEstadio36Meses=4 then 'Estadio IV' 
            end as tipo_estadio_36_meses, 
           ...
           via36Meses.via_36_meses,
           viaPositivo36Meses.via_positivo_36_meses,
             case 
        ...
        (
         ...
         SELECT tx_new.patient_id,tx_new.art_start_date
           FROM 
              ...
              AND e.location_id=3 
              AND e.encounter_datetime <=date_sub(date(concat('2023','-06','-20')), interval 24 MONTH)
              ...
              AND o.value_datetime <=date_sub(date(concat('2023','-06','-20')), interval 24 MONTH)
              AND e.location_id=3 
              GROUP BY p.patient_id 
              ) 
              art_start GROUP BY patient_id 
          ) tx_new WHERE art_start_date BETWEEN  date_sub(date(concat('2023','-12','-21')), interval 48 MONTH) and  date_sub(date(concat('2023','-06','-20')), interval 36 MONTH)
            )coorte36Meses
            left join
        (
           SELECT tr.patient_id, tr.data_transferencia from  
              (
                ...
                WHERE p.voided=0 AND e.voided=0 AND e.encounter_type=53 and obsData.value_datetime<=date_sub(date(concat('2023','-06','-20')), interval 36 MONTH)
                AND e.location_id=3 
                GROUP BY p.patient_id 
                union
                ...
                WHERE pg.voided=0 
                and ps.start_date<=date_sub(date(concat('2023','-06','-20')), interval 36 MONTH)
                and ps.voided=0 
                and p.voided=0 
                and pg.program_id=2 
                and location_id=3  
                       ...
                       FROM 
                        ...
                        (
                           select p.patient_id,e.encounter_datetime data_primeiro_pedido_cv_36_meses, e.encounter_id
                                ...
                                and e.encounter_type=6 and e.location_id=3 
      ...
      (
          select tx_new.patient_id,tx_new.art_start_date,
                    p.gender,
                    gravidaLactante36Meses.data_gravida_lactante,
        ...
        )estadiamentoClinico36Meses  on estadiamentoClinico36Meses.patient_id=coorteFinal.patient_id 
       ...
       (
        select tb36Meses.patient_id,tb36Meses.data_tb_36_meses,tb36Meses.data_tb_36_meses  tb_36_meses from 
          ...
          from patient p 
              ...
              inner join encounter e on p.patient_id=e.patient_id 
              inner join obs o on o.encounter_id=e.encounter_id 
              where e.encounter_type in(6) and o.concept_id=1268 and o.value_coded in(1256,1257)  and e.location_id=3 
              and e.voided=0 and p.voided=0 and o.voided=0 
              )tb36Meses
      ...
      select primeiroMdc.patient_id,primeiroMdc.data_mdc data_registo_primeiro_mdc from 
       ...
       (
          ...
          from    
           ...
           group by tx_new.patient_id
            ...
            (
             ...
             )pf36Meses on pf36Meses.patient_id=coorteFinal.patient_id 
             left join
             (
               select  tx_new.patient_id,
                   tx_new.art_start_date,
                   tpt36Meses.data_inicio_tpt_24_meses,
                   if((tpt36Meses.data_inicio_tpt_24_meses BETWEEN date_add(tx_new.art_start_date, interval 24 month) and date_add(tx_new.art_start_date, interval 36 month)),'Sim','Não') tpt_36_meses,
                ...
                (
                    ...
                    group by tx_new.patient_id order by tx_new.patient_id,tpt36Meses.data_inicio_tpt_24_meses
              )tpt36Meses on tpt36Meses.patient_id=coorteFinal.patient_id 
                
            left join
            (
             select  pbImc36Meses.patient_id,if(count(pbImc36Meses.consultas_pb_imc_36_meses)=count(pbImc36Meses.consultas_pb_imc_36_meses_2),'Sim','Não') consultas_pb_imc_36_meses
               from 
                    (
                    ...
                    select  p.patient_id,e.encounter_datetime consultas_pb_imc_36_meses 
                     from
                       ...
                       (
                        ...
                        where e.encounter_type=6   and e.location_id=3 and e.voided=0
        ...
        )todasConsultas36MesesPA on todasConsultas36MesesPA.patient_id=coorteFinal.patient_id 
        ...
        group by consultas36Meses.patient_id
                ...
                left join
                  ( 
                   ...
                   FROM 
                      ...
                      patient p 
                      inner join encounter e on p.patient_id=e.patient_id 
                      where e.encounter_type=35 and e.location_id=3 and e.voided=0 and p.voided=0 and e.voided=0
                      order by p.patient_id
                      )consultas36Meses
                      inner join 
                      (
                ...
                from( 
                   ...
                   inner join person p on p.person_id=tx_new.patient_id
                 --group by tx_new.patient_id order by tx_new.patient_id,via36Meses.encounter_datetime
                )via36Meses on via36Meses.patient_id=coorteFinal.patient_id 
                left join
                (
                    select tx_new.patient_id,
                        tx_new.art_start_date, 
                        viaPositivo36Meses.encounter_datetime,
                        if(p.gender='M','N/A', 
                ...
                )viaPositivo36Meses on viaPositivo36Meses.patient_id=coorteFinal.patient_id 
                     ...
                     (
                      ...
                      SELECT tx_new.patient_id,tx_new.art_start_date
                           FROM 
                              ...
                              WHERE e.voided=0 AND o.voided=0 AND p.voided=0 AND e.encounter_type in (18) 
                              AND e.location_id=3 
                              AND e.encounter_datetime <=date_sub(date(concat('2023','-06','-20')), interval 36 MONTH)
                              GROUP BY p.patient_id 
                              UNION 
                              SELECT p.patient_id, MIN(value_datetime) art_start_date FROM 
                              patient p 
                              ...
                              WHERE p.voided=0 AND e.voided=0 AND o.voided=0 AND e.encounter_type=52 
                              AND o.concept_id=23866 AND o.value_datetime is NOT NULL 
                              AND o.value_datetime <=date_sub(date(concat('2023','-06','-20')), interval 36 MONTH)
                              AND e.location_id=3 
                              GROUP BY p.patient_id 
                              ) 
                              art_start GROUP BY patient_id 
                          ) tx_new --WHERE art_start_date BETWEEN  date_sub(date(concat('2023','-12','-21')), interval 48 MONTH) and   date_sub(date(concat('2023','-12','-21')), interval 36 MONTH)
                        )tx_new
                     inner join 
                      (
                      ...
                      and obsLevantou.value_coded=1065 and obsLevantou.voided=0 and e.encounter_type=52 and e.location_id=3 
                      union 
                      ...
                      (
                               ...
                               SELECT tx_new.patient_id,tx_new.art_start_date
                                 FROM 
                                    ...
                                    art_start GROUP BY patient_id 
                                ) tx_new --WHERE art_start_date BETWEEN  date_sub(date(concat('2023','-12','-21')), interval 48 MONTH) and   date_sub(date(concat('2023','-12','-21')), interval 12 month)
                            )tx_new
                            inner join
                            ( 
                            ...
                            and pg.location_id=3 
                            group by p.patient_id  
                            ) maxEstado 
                            inner join patient_program pg2 on pg2.patient_id=maxEstado.patient_id 
                            inner join patient_state ps2 on pg2.patient_program_id=ps2.patient_program_id 
                            where pg2.voided=0 and ps2.voided=0 and pg2.program_id=2 and 
                            ps2.start_date=maxEstado.data_obito and pg2.location_id=3 and ps2.state in (7,8,10)
                            union 
                            ...
                            and o.voided=0 and o.concept_id=6272 and o.value_coded in(1366,1709,1706) and e.encounter_type=53 and  e.location_id=3 
                            --group by p.patient_id 
                            union  
                            ...
                            and o.voided=0 and o.concept_id=6273 and o.value_coded in(1366,1709,1706) and e.encounter_type=6 and  e.location_id=3 
                            --group by p.patient_id 
                            union  
                            ...
                            inner join patient_state ps2 on pg2.patient_program_id=ps2.patient_program_id 
                            where pg2.voided=0 and ps2.voided=0 and pg2.program_id=2 and 
                            ps2.start_date=maxEstado.data_obito and pg2.location_id=3 and ps2.state=10 
                            union 
                            select p.patient_id,o.obs_datetime data_obito from  patient p 
                            inner join encounter e on p.patient_id=e.patient_id 
                            inner join obs o on o.encounter_id=e.encounter_id 
                            where e.voided=0 and p.voided=0 
                            --and o.obs_datetime<=NOW()  
                            and o.voided=0 and o.concept_id=6272 and o.value_coded=1366 and e.encounter_type=53 and  e.location_id=3 
                            --group by p.patient_id 
                            union  
                            select p.patient_id,e.encounter_datetime data_obito from patient p 
                            inner join encounter e on p.patient_id=e.patient_id 
                            inner join obs o on o.encounter_id=e.encounter_id where e.voided=0 and p.voided=0 
                            --and e.encounter_datetime<=NOW() 
                            and o.voided=0 and o.concept_id=6273 and o.value_coded=1366 and e.encounter_type=6 and  e.location_id=3 
                            --group by p.patient_id 
                            union  
                            Select person_id,death_date from person p where p.dead=1 
                            --and p.death_date<=NOW()  
                       ...
                       select tx_new.patient_id,  3 tipo_saida 
                            ...
                            ps2.start_date=maxEstado.data_suspencao and pg2.location_id=3 and ps2.state=8 
                            union 
                            ...
                            and o.value_coded=1709 and e.encounter_type=53 and  e.location_id=3 
                            --group by p.patient_id 
                            union 
                            ...
                            and o.value_coded=1709 and e.encounter_type=6 and  e.location_id=3 
                            --group by p.patient_id  
                            ) suspenso 
                            --group by patient_id 
                               ...
                               select transferido.patient_id,max(transferido.data_transferidopara) data_transferidopara
                                  ...
                                  (
                                    ...
                                    left join encounter ultimo_fila_data_criacao on ultimo_fila_data_criacao.patient_id=ultimo_fila.patient_id 
                                     ...
                                     and ultimo_fila_data_criacao.location_id=3 
                                     left join 
              ...
              select coorte12meses_final.patient_id 
                from( 
                     ...
                     from( 
                                ...
                                Select patient_id, min(data_inicio) data_inicio 
                                 from ( 
                                        ...
                                        (
                                         ...
                                         and e.location_id=3 and YEAR(STR_TO_DATE(e.encounter_datetime, '%Y-%m-%d')) >= 1000
                                             group by p.patient_id
                                         union
                                         ...
                                         where p.voided=0 and e.voided=0 and o.voided=0 and e.encounter_type=52 and  o.concept_id=23866
                                             and o.value_datetime is not null and  o.value_datetime<=CURDATE() and e.location_id=3
                                        ...
                                        from(
                                            select saidas_por_suspensao.patient_id, saidas_por_suspensao.data_estado 
                                                        ...
                                                        from( 
                                                            ...
                                                            from( 
                                                             ...
                                                             from patient p 
                                                                inner join patient_program pg on p.patient_id=pg.patient_id 
                                                                  inner join patient_state ps on pg.patient_program_id=ps.patient_program_id 
                                                                where pg.voided=0 and ps.voided=0 and p.voided=0 and pg.program_id=2 and ps.start_date<=CURDATE() and pg.location_id=3 
                                                                group by p.patient_id 
                                                        ) 
                                                      maxEstado 
                                                        inner join patient_program pg2 on pg2.patient_id=maxEstado.patient_id 
                                                    ...
                                                    where pg2.voided=0 and ps2.voided=0 and pg2.program_id=2 
                                                        and ps2.start_date=maxEstado.data_estado and pg2.location_id=3 and ps2.state =8 
                                                    ...
                                                    union 
                                                        ...
                                                        and o.value_coded in (1709) and o.obs_datetime<=CURDATE() and e.location_id=3 
                                                            group by p.patient_id 
                                        ...
                                        from(
                                            ...
                                            from (  
                                                ...
                                                where e.voided=0 and o.voided=0 and p.voided=0 and pe.voided = 0                                                               
                                                    ...
                                                    and o.obs_datetime<=CURDATE() and e.location_id=3                                                                        
                                                    group by p.patient_id                                                                                                               
                                    ...
                                    left join(
                                        ...
                                        from(
                                            ...
                                            where p.voided=0 and pe.voided = 0 and e.voided=0 and e.encounter_type=18                                                                      
                                                and e.location_id=3 and e.encounter_datetime<=CURDATE()                                                                                  
                                                group by p.patient_id  
                                        ...
                                        from (
                                            ...
                                            from ( 
                                                ...
                                                from( 
                                                   ...
                                                   from patient p 
                                                          inner join encounter e on e.patient_id=p.patient_id 
                                                   where p.voided=0 and e.voided=0 and e.encounter_type=18 and e.location_id=3 and date(e.encounter_datetime)<=CURDATE() 
                                                         group by p.patient_id 
                                                  )fila 
                                          ...
                                          left join encounter ultimo_fila_data_criacao on ultimo_fila_data_criacao.patient_id=maxFila.patient_id 
                                           ...
                                           left join obs obs_fila on obs_fila.person_id=maxFila.patient_id 
                                            ...
                                            where p.voided=0 and pe.voided = 0 and e.voided=0 and o.voided=0 and e.encounter_type=52                                                       
                                                 and o.concept_id=23866 and o.value_datetime is not null and e.location_id=3 and o.value_datetime<=CURDATE()                                                                                        
                                            group by p.patient_id
                           ...
                           ( 
                            ...
                            (
                               ...
                               ( 
                                    ...
                                    inner join encounter e on e.patient_id=p.patient_id 
                                    where p.voided=0 and e.voided=0 and e.encounter_type=18 and e.location_id=3 
                           ...
                           (
                            ...
                            (
                               ...
                               from patient p 
                                   inner join encounter e on e.patient_id=p.patient_id 
                               where p.voided=0 and e.voided=0 and e.encounter_type in (6,9) and  e.location_id=3 and e.encounter_datetime<=CURDATE() 
                                   group by p.patient_id 
                                union
                 ...
                 )activo36Meses on activo36Meses.patient_id=coorteFinal.patient_id and coorteFinal.tipo_coorte=36

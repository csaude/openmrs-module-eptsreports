 select                             coorte12meses_final.patient_id,                              
                                    ...
                                    coorte12meses_final.data_fila ultimo_lev,                              
                                    ...
                                    consultaClinica.data_seguimento ultimaConsulta,                              
                                    ...
                                    max_consultaApss.data_seguimento ultimaConsultaApss,
                                    max_consultaApss.value_datetime proximaConsultaApss,
			            ...
			            (select inicio.*,                                                                                                                    
			                ...
			                select patient_id,max(data_estado) data_estado                                                                                              
			                     from                                                                                                                                        
			                         (                                                                                                                                       
			                             ...
			                             where pp.program_id = 2 and ps.state = 8 and pp.voided = 0 and ps.voided = 0 and pp.location_id = 277                 
						                           		...
						                           		(                                                                
							                             	...
							                             	from (                                                                                                                              
							                                     ...
							                                     where e.voided=0 and p.voided=0 and e.encounter_datetime<= :endDate                                       
							                                         and e.encounter_type = 21 and  e.location_id= 277                                                                 
							                                         group by p.patient_id                                                                                                   
							                                 ) ultimaBusca                                                                                                                   
							                                     inner join encounter e on e.patient_id = ultimaBusca.patient_id                                                             
							                                     inner join obs o on o.encounter_id = e.encounter_id                                                                         
							                                where e.encounter_type = 21 and o.voided=0 and o.concept_id=2016 and o.value_coded in (1706,23863) and ultimaBusca.data_estado = e.encounter_datetime and e.location_id = 277 
			             ...
			             where (data_estado is null or (data_estado is not null and  data_fila > data_estado))
                         ...
                         (                                                                                                                                                                                                                                                                                        
                           ...
                           where p.voided=0 and e.voided=0 
                                 and e.encounter_datetime<=curdate() and e.encounter_type=35 
                                 and e.location_id=:location                                                                                                                                                                                                                       
                                 group by p.patient_id                                                                                                                                                                                                                                                            
                         )maxConsent                                                                                                                                                                                                                                                                              
                         inner join encounter e on e.patient_id=maxConsent.patient_id                                                                                                                                                                                                     
                         inner join obs o on o.encounter_id=e.encounter_id                                                                                                                                                                                                                
                         where e.voided=0 and o.voided=0 and e.encounter_type=35 and  o.concept_id=6306 and e.location_id=:location 
                          and e.encounter_datetime=maxConsent.dataConsentimento                                                                                                                                                                                                        
                     ...
                     select max_consulta.patient_id,max_consulta.data_seguimento,obs_seguimento.value_datetime 
			           ...
			           left join person_attribute patOVCStatus on patOVCStatus.person_id=coorte12meses_final.patient_id and patOVCStatus.person_attribute_type_id=52 and patOVCStatus.value is not null and patOVCStatus.value <> '' and patOVCStatus.voided=0 
                         where datediff(:endDate,data_usar)>=3 and datediff(:endDate,data_usar) between :minDelayDays AND :maxDelayDays
